...
final class ShortcutsIntegration {
    ...
    1. ADD ACTION: "FIND MESSAGES"
       - FILTER: RECIPIENT IS [CONTACT NAME]
    ...
    3. INSIDE REPEAT:
       ADD ACTION: "TEXT"
       CONTENT: {"sender":"[SENDER]","text":"[TEXT]","date":"[DATE SENT]","is_from_me":[IS FROM ME]}

    4. ADD ACTION: "COMBINE TEXT"
       SEPARATOR: COMMA

    5. ADD ACTION: "TEXT"
       CONTENT: [[COMBINED TEXT]]

    6. ADD ACTION: "OPEN URL"
       URL: ra://import?data=[BASE64 ENCODE ABOVE]

    OR SIMPLER:
    6. ADD ACTION: "SHARE"
       SAVE AS: messages.json
       OPEN WITH: RELATIONSHIP ANALYTICS
    """
}
